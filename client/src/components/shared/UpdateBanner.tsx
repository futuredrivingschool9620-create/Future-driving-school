          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                {isUpdating
                  ? statusText || 'Installing in-app update, please wait...'
                  : 'A new update is available. Install in-app without leaving the app.'}
              </p>
            </div>
          </div>
            ...
            >
              {isUpdating ? (
                <>
                  ...
                  <span>{statusText || 'Updating in-app...'}</span>
                </>
              ) : (
                <span>Update in App Now</span>
              )}
            </button>
          </div>
        </div>
