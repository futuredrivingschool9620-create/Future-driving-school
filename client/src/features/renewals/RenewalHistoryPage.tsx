        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-rose-600 hover:bg-rose-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-medium rounded-lg shadow-sm hover:shadow transition-all"
            >
          ...
          <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-700 bg-white/50 dark:bg-slate-900/50">
              {isLoading ? (
                ...
                <>
                  {topSpacerHeight > 0 && (
                    <tr style={{ height: topSpacerHeight, border: 0 }}><td colSpan={6} style={{ height: topSpacerHeight, padding: 0, border: 0 }} /></tr>
                  )}
                  ...
                  {bottomSpacerHeight > 0 && (
                    <tr style={{ height: bottomSpacerHeight, border: 0 }}><td colSpan={6} style={{ height: bottomSpacerHeight, padding: 0, border: 0 }} /></tr>
                  )}
                </>
              )}
            </tbody>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-2">
              ...
              <p className="text-xs text-rose-600 dark:text-rose-400 pt-2 border-t border-slate-200 dark:border-slate-700">
                All renewal history entries recorded within this period across all users will be removed.
              </p>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-rose-600 hover:bg-rose-700 rounded-xl shadow-sm hover:shadow transition-all disabled:opacity-50"
              >
                {isDeletingRange ? (
                  <>
